...
Background::Background()
	: Sphere(4000, 45, 45)	//Sphere(구)의 중심 좌표 설정
...
void Background::init()
{
	...
	unsigned char * data = loadBMPRaw("Background.bmp", width, height, false);	//"mars.bmp"파일을 불러온다
...
void Background::draw()	//화면에 mars를 그린다
{
