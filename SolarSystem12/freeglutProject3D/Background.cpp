/***************************************************************************************************
파 일 명 : Background.cpp
목    적 : Background 클래스 정의
...
/* Sphere 클래스를 상속 받는 Background 클래스 생성자 정의 */
Background::Background() : Sphere(4000, 45, 45)	//구의 중심 좌표 설정
{
	init();
}

/* Background 클래스 소멸자 정의 */
...
기능 : 우주 배경 이미지를 구에 매핑해주기 위한 초기화 함수
인자 : void
반환 : void
*/
void Background::init()
{
	...
	unsigned char * data = loadBMPRaw("Background.bmp", width, height, false);	//"background.bmp"파일을 불러온다
...
기능 : 우주 배경 이미지가 매핑된 구를 그려주는 프러시저
인자 : void
반환 : void
*/
