...
Saturn::Saturn()		//Earth의 생성자
	: Sphere(35, 45, 45)	//Sphere(구)의 중심 좌표 설정
...
void Saturn::init()
{
	...
	unsigned char * data = loadBMPRaw("saturn.bmp", width, height, false);	//"earth.bmp"파일을 불러온다
...
void Saturn::draw()	//화면에 Earth를 그린다
{
