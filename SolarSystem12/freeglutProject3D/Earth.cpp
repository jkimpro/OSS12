...
/* Sphere 클래스를 상속 받는 Earth 클래스 생성자 정의 */
Earth::Earth() : Sphere(4, 45, 45) //구의 중심 좌표 설정
{
	init();
}

/* Sphere 클래스를 상속 받는 Earth 클래스 소멸자 정의 */
Earth::~Earth()
{
	Sphere::~Sphere();
}
