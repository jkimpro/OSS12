...
Naptune::Naptune()		//Naptune의 생성자
	: Sphere(9, 45, 45)	//Sphere(구)의 중심 좌표 설정
...
void Naptune::init()
{
	...
	unsigned char * data = loadBMPRaw("neptune.bmp", width, height, false);	//"Naptune.bmp"파일을 불러온다
...
void Naptune::draw()	//화면에 Naptune를 그린다
{
